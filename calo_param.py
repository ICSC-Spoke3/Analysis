...
if __name__ == '__main__':
    ...
    #for i in range(nevts):
        try:
            ...
            #print ("Exit")
            raise
        output_filename = f'NUSES_wt_CaloHERDprotonMono_20000-0.25_onAxis_20000-evt-3'
        #print("Ev = ", i)
        data_param.append([i, R1_values, R2_values, R3_values,  R4_values,  R5_values,  R6_values])
        #data_param.append([i,  R4_values])
        #data=pd.DataFrame(data_param,columns=['Ev', 'R4'])
        data=pd.DataFrame(data_param,columns=['Ev','R1','R2', 'R3', 'R4', 'R5', 'R6'])
...
# Disegno dell'istogramma sul TCanvas
    #h1.Draw()

# Salvataggio del TCanvas come file immagine
    #canvas.SaveAs("RMolier_e-_20000MeV.png")